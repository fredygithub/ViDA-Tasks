...
-- select [active?], count(*) from Vida.dbo.Accounts where Gender is null group by [active?] 

-->Male/Female /*select Gender, count(*) cnt from Vida.dbo.Accounts group by Gender*/
    Male- 4
    Female- 2
